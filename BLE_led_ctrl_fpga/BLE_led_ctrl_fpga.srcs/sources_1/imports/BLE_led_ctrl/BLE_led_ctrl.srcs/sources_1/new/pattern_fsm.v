...
module pattern_fsm #(
parameter BLINK_ON_TICKS  = 24'd5,
parameter BLINK_OFF_TICKS = 24'd5,

parameter PULSE_ON_TICKS  = 24'd2,
parameter PULSE_OFF_TICKS = 24'd15,

parameter BREATHE_STEP_TICKS = 24'd1_000_000
)(
  ...
  output reg [23:0] phase_load,

  output reg duration_start,
  output reg [23:0] duration_load,
...
localparam S_RAMP_DOWN = 3'd4;
  ...
  always @(*) begin
    ...
    duration_start = 0;
    duration_load  = 24'b111111111111111111111111;
